...
class UsersModelTest(TestCase):
    ...
    def test_user_check_subscription(self):
        self.assertFalse(self.user.check_subscription())
        paid_cost = UserSubscription.check_cost(months_count=2)
        ...
        self.assertTrue(self.user.check_subscription())
    ...
    def test_user_subscription_check_cost(self):
        ...
        self.assertEqual(UserSubscription.check_cost(months_count=1), one_month_cost)
        self.assertEqual(UserSubscription.check_cost(months_count=3),
                         round(3 * one_month_cost * UserSubscription.DEPRECIATION_FOR_THREE_MONTHS, 2))
        self.assertEqual(UserSubscription.check_cost(months_count=7),
                         round(7 * one_month_cost * UserSubscription.DEPRECIATION_FOR_SIX_MONTHS, 2))
        self.assertEqual(UserSubscription.check_cost(months_count=14),
